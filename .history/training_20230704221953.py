...
def decode_audio(audio_binary):
    print('audio_binary', type(audio_binary))
...
def save_model(model, path):
    ...
    # bentoml:
    bentoml.keras.save_model(f'{path}_bento', model)

def main():
    ## downloading dataset
    train_files, val_files, test_files = get_data(DATASET_PATH)
    ...
    # save_model(model, 'audio_commands_model')
